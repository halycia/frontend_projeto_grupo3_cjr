    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                console.log('Resposta completa da API:', response); // Debug adicional
                setTextInput(response.data.conteudo || ''); // Atualiza o estado
            ...
            setIsLoading(false);
            onClose(); // Certifique-se de fechar o modal por último
        }
    };
